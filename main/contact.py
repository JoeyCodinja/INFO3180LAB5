...
class ContactUpdateForm(wtf.Form):
  ...
  address = wtf.StringField('Address', [wtf.validators.optional()])
...
def contact_create():
  ...
  if form.validate_on_submit():
    ...
    contact_db.put()
    flask.flash('New Contact was succcessfully created!', category='success')
    return flask.redirect(flask.url_for('contact_list', order='-created'))
  return flask.render_template('contact_update.html',
...
def contact_update(contact_id):
  ...
  return flask.redner_template('contact_update.html',
